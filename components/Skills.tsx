...
function Skills() {
  ...
  useEffect(() => handleAnimation(percantge, setPercantge, 90), [isVisible, percantge]);
  useEffect(() => handleAnimation(percantgeI, setPercantgeI, 95), [isVisible, percantgeI]);
  useEffect(() => handleAnimation(percantgeIV, setPercantgeIV, 93), [isVisible, percantgeIV]);



  {/*
     ///just testing : long code///
