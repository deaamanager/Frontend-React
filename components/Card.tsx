...
const Images = [
  {
    ...
    titleI: "Redux: state management tool for JavaScript applications, making it easier to control data flow",
    titleIV: "Firebase:  Google platform for web and mobile app development that provides services such as databases, authentication, and hosting",
    link: "https://netflex-clone-a2c65.web.app/",
  },
  {
    image: "https://cdn.sanity.io/images/7n5v8za3/production/1f654e6c35adabc74e50c23c67fe71fa66851aaf-731x477.svg",
    technologies: ["https://cdn.sanity.io/images/7n5v8za3/production/e4d1a7214013df1d10ff09b11cb62730fe85d9c1-225x225.png", "https://cdn.sanity.io/images/7n5v8za3/production/ec85d60e35ac7570017f90d93c1cfd7bf1e77bcb-2048x2048.png","https://cdn.sanity.io/images/7n5v8za3/production/e5fc9de77d06ace427f0310d25ef62e2ced56d3a-1024x1024.png","https://cdn.sanity.io/images/7n5v8za3/production/d1ade0293b31972292028de376bd5403c6e225a9-640x320.png","https://cdn.sanity.io/images/7n5v8za3/production/ddd7f70f28c091c7611162f0544e30d48b11e9ce-1600x1200.webp"],
    name: "Case Study 2/3: Web-site with ( CMS & Email Engine )",
    title: "Next.js 13 & TailwindCss: providing a streamlined workflow and optimized performance",
    titleI: "Sanity & Nodemailer: Managing content with a customizable CMS and sending emails using Nodemailer for server-side email handling",
    titleIV: "Framer-motion: Adding smooth animations and interactive motion effects to enhance the user experience",
  ...
  },
  {
    ...
    title: "Next.js & TailwindCss: Building performant and responsive React applications with a utility-first CSS framework",
    titleI: "Three.js:  Creating immersive 3D visualizations and interactive experiences using the powerful combination of THREE.js library with React Fiber and React Drei",
        ...
        Images.map((image, i) => (
          ...
          <div
            ...
            className=" w-[300%]  realtive  text-white flex-col flex items-center justify-center py-24 cursor-grab">
              ...
              width={300}
              height={400}
              src={image.image} alt="projeckts " className=" h-[15rem] pb-10" />
              <div className="flex flex-row gap-x-3  pb-5  text-white">
                {image.technologies.map((tech,i)=>(
                 <div key={i}>
                   ...
                   height={50}
                   alt="Technologies" 
                   className="rounded-full h-10 w-10 mix-blend-screen border-none" />
                 </div>
                ))}
              </div>
                ...
                <div className="relative group ">
                  <div className="absolute -inset-0.5   opacity-75 bg-gradient-to-r from-[#fff] via-[#111] to-[#fff]  rounded-xl blur-xl
                   ...
                   <button className=' relative divide-x divide-gray-600 px-4 py-4 bg-black rounded-xl leading-none flex items-center'>
                    ...
                    <span className='text-[#25D366]/50 px-3 group-hover:text-gray-100 transition duration-200'>Go Live To Demo</span>
                  </button>
                   </Link>
                </div>
              </motion.div>
